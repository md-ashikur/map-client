...
const ProjectListItem = (props) => {
  return (
    <div className=" relative items-center">
      <Link className=" font-semibold text-slate-800" to={props.link}>
        <div
          className={`flex items-center justify-between shadow-lg rounded-sm border w-auto  m-2  px-5 py-4 ${
            props.type === "Featured"
          ...
          <div className="md:flex justify-between  items-center space-y-4 md:space-y-0 space-x-2">
            ...
            <div className="flex items-start items-center space-x-3 md:space-x-4">
              ...
              <div>
               ...
               <div className="flex lg:flex-row md:flex-row flex-col place-items-start lg:place-items-center md:place-items-center ">
               <h3> {props.role}</h3>
           ...
           {/* Right side */}
           <div className="flex block md:hidden lg:hidden items-center relative left-10 space-x-4  md:pl-0">
              ...
              <div className="flex hidden md:block lg:block items-center relative right-10 space-x-4  md:pl-0">
              <div className="text-sm text-slate-500 whitespace-nowrap">
                {props.date}
              </div>
            </div>
