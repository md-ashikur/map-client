      ...
      <div className="px-5 py-6">
        <div className="md:flex md:justify-between md:items-center">
          ...
          <ul className="shrink-0 flex flex-wrap justify-end md:justify-start -space-x-3 -ml-px">
            ...
            <li>
              <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white border border-slate-200 hover:border-slate-300 text-secondary-light shadow-sm transition duration-150">
