              ...
              <div className="max-w-md mx-auto">
                ...
                <form>
                    ...
                    <label className="relative block cursor-pointer">
                      ...
                      <div className="flex items-center bg-white text-sm font-medium text-slate-800 p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                        <svg className="w-6 h-6 shrink-0 fill-current mr-4" viewBox="0 0 24 24">
                          <path className="text-secondary-dark" d="m12 10.856 9-5-8.514-4.73a1 1 0 0 0-.972 0L3 5.856l9 5Z" />
                          <path className="text-secondary" d="m11 12.588-9-5V18a1 1 0 0 0 .514.874L11 23.588v-11Z" />
                          <path className="text-secondary-light opacity-50" d="M13 12.588v11l8.486-4.714A1 1 0 0 0 22 18V7.589l-9 4.999Z" />
                        </svg>
                  ...
                  <div className="flex items-center justify-between">
                    <Link className="btn bg-secondary hover:bg-secondary-dark text-white ml-auto" to="/onboarding-02">Next Step -&gt;</Link>
                  </div>
                </form>
