              ...
              <div>
                ...
                <div className="bg-white p-5 shadow-lg rounded-sm border border-slate-200 mb-6 lg:hidden">
                  ...
                  <div className="space-y-2 sm:flex sm:space-y-0 sm:space-x-2">
                    <button className="btn w-full bg-secondary hover:bg-secondary-dark text-white">Apply Today -&gt;</button>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex justify-between items-center">
                    {/* Apply button */}
                    <button className="btn bg-secondary hover:bg-secondary-dark text-white whitespace-nowrap">Apply Today -&gt;</button>
                    {/* Share */}
